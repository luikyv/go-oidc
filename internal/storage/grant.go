...
func (m *GrantManager) Grant(_ context.Context, id string) (*goidc.Grant, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *GrantManager) GrantByRefreshToken(_ context.Context, tkn string) (*goidc.Grant, error) {
