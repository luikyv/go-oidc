...
func NewContext(t testing.TB) oidc.Context {
	...
	config := &oidc.Configuration{
		...
		UserInfoDefaultSigAlg:       jose.SignatureAlgorithm(jwk.Algorithm),
		UserInfoSigAlgs:             []jose.SignatureAlgorithm{jose.SignatureAlgorithm(jwk.Algorithm)},
		IDTokenDefaultSigAlg:        jose.SignatureAlgorithm(jwk.Algorithm),
		IDTokenSigAlgs:              []jose.SignatureAlgorithm{jose.SignatureAlgorithm(jwk.Algorithm)},
